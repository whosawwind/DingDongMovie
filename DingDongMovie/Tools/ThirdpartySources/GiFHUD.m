...
- (instancetype)init {
    if ((self = [super initWithFrame:CGRectMake(0, 0, Size, Size)])) {
        ...
        self.imageView = [[UIImageView alloc] initWithFrame:CGRectInset(self.bounds, 20, 15)];
        [self addSubview:self.imageView];
        
        /* Xu Write */
        self.textLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.imageView.frame.origin.x + 20, self.imageView.frame.origin.y + self.imageView.frame.size.height - 7, self.imageView.frame.size.width, 30)];
